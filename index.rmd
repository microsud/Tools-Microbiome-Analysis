...
CMMB [Compositional Mediation Model for Binary Outcomes](https://github.com/mbsohn/cmmb)  
...
microeco [an R package for data mining in microbial community ecology](https://github.com/ChiLiubio/microeco)   
...
MiATDS [A powerful adaptive microbiome-based association test for microbial association signals with diverse sparsity levels](https://pubmed.ncbi.nlm.nih.gov/34411712/)    
...
rANOMALY [AmplicoN wOrkflow for Microbial community AnaLYsis](https://f1000research.com/articles/10-7/v1)   
RobZS [Sparse least trimmed squares regression with compositional covariates for high dimensional data](https://github.com/giannamonti/RobZS)   
...
SuRF [A new method for sparse variable selection, with application in microbiome data analysis](https://onlinelibrary.wiley.com/doi/10.1002/sim.8809)  
...
timeOmics [an R package for longitudinal multi-omics data integration](https://github.com/abodein/timeOmics)  
